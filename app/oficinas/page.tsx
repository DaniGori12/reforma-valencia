        ...
        return (
          <div key="asdf">
            ...
            <div className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h3>Descubre tu nueva empresa de Reformas de Oficinas en Valencia, que sí cumple con lo que promete</h3>
              <hr></hr>
              ...
              <Boton></Boton>
              <h3 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas de oficinas en Valencia son tu mejor garantía</h3>
              <hr></hr>
              {body2}
