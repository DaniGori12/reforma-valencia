...
export const metadata = {
  title: 'Reformas integrales Burjassot',
  description: 'Empresa de reformas en Burjassot. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}

export default async function Burjassot() {
  ...
  return (
    <main>
      ...
      {landingTeam?.map((singlePost: any) => {
        const {headerBody, headerMedia, body, body2, body3, body4, gridText,roomMedia, roomMedia2, roomMedia3, 
          roomMedia4, roomMedia5, roomMedia6, roomMedia7, roomMedia8, roomMedia9,
} = singlePost.fields;
        return (
          <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Burjassot</h1>
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h2>Descubre tu nueva empresa de Reformas en Burjassot, que sí cumple con lo que promete</h2>
              <hr></hr>
              ...
              <Boton></Boton>
              <h3 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas en Burjassot son tu mejor garantía</h3>
              <hr></hr>
              {body2}
...
<img
  ...
  />
              ...
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Burjassot</h2>
              <hr ></hr>
            </article>
          </div>
        )
      ...
      {landingMunicipios?.map((singlePost: any) => {
        const {body, body2, mediaCocina2, mediaBano2, cocinaBurjassot, banoBurjassot, title, gridMedia, gridBody, bodyBurjassot} = singlePost.fields;
        return (
          <main key={"alb"}>
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
          ...
          <div className='grid grid-cols-2 gap-5 px-44 max-xl:px-5 max-2xl:grid-cols-1'>
              ...
              <Boton></Boton>
          <a className='mx-5 flex flex-col centrar text-left gap-5'>{documentToReactComponents(bodyBurjassot)}</a>
            </article>
          </main>
        )})}
