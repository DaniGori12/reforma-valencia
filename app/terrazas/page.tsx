          ...
          <div key="asdf">
            <div className='max-h-72 w-screen pb-10 overflow-hidden relative '>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 text-white font-bold max-sm:top-10'>
                <p className='text-lg'>Reformas de Terrazas en Valencia</p>
            ...
            <div className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h3>Descubre tu nueva empresa de Reformas de Terrazas en Valencia, que sí cumple con lo que promete</h3>
              <hr></hr>
              ...
              <h3 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas de terrazas en Valencia son tu mejor garantía</h3>
              <hr></hr>
              {body2}
        ...
        return (
          <div key="" className='flex flex-col text-center mt-20 px-56 gap-10 max-xl:px-5 items-center'>
            ...
            <div className='flex gap-5 px-56 max-xl:px-5 max-lg:flex-col justify-center text-center'>
              ...
              <button className='boton'>SOLICITA TU PRESUPUESTO GRATIS</button>
              <a className=' flex flex-col gap-5 items-center text-left px-56 max-xl:px-5'>{documentToReactComponents(bodyTerrazas2)}</a>
