...
export const metadata = {
  title: 'Reformas integrales Olivereta',
  description: 'Empresa de reformas en Olivereta. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}

export default async function Olivereta() {
  ...
  return (
    <main>
          ...
          <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Olivereta</h1>
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h2>Descubre tu nueva empresa de Reformas en Olivereta, que sí cumple con lo que promete</h2>
              <hr></hr>
              ...
              <Boton></Boton>
              <h3 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas en Olivereta son tu mejor garantía</h3>
              <hr></hr>
              {body2}
              ...
              <div className='grid grid-cols-3 gap-2 max-xl:px-5 px-44 max-lg:grid-cols-2 max-sm:grid-cols-1'>
                <img src={'https://' + roomMedia.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia2.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia3.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia4.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia5.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia6.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia7.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia8.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
                <img src={'https://' + roomMedia9.fields.file.url} alt="Habitación de una casa" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
              </div>
              <p className='px-56 gap-10 max-xl:px-5'>{body4}</p>
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Olivereta</h2>
              <hr ></hr>
      ...
      {landingBarrios?.map((singlePost: any) => {
        const { body, title, bodyGrid, mediaGrid, bodyOlivereta } = singlePost.fields;
        return (
          <main key="beni">
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              ...
              <a className=' px-56 gap-5 max-xl:px-5 flex flex-col centrar text-left'>{documentToReactComponents(bodyOlivereta)}</a>
