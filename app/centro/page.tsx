          ...
          <div key="asdf">
            <div className='max-h-72 w-screen pb-10 overflow-hidden relative '>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 text-white font-bold max-sm:top-10'>
                <p className='text-lg'> Reformas integrales en el Centro</p>
            ...
            <div className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h3>Descubre tu nueva empresa de Reformas en el Centro, que sí cumple con lo que promete</h3>
              <hr></hr>
              ...
              <h3 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas en el Centro son tu mejor garantía</h3>
              <hr></hr>
              {body2}
        ...
        return (
          <main key="centro">
            <div className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              ...
              <a className=' px-56 gap-10 max-xl:px-5 flex flex-col items-center text-left '>{documentToReactComponents(bodyCentro)}</a>
