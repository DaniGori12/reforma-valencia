...
export function Carrusel() {
    return (
            ...
            <div className="carousel w-1/2 max-lg:w-screen max-sm:hidden">
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div className="flex items-center">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-cyan-950">Experiencia Increíble</p>
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div className="flex items-center">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-cyan-950">Maravillosa Transformación</p>
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div className="flex items-center">
                            <div>
                                ...
                                <div className="text-yellow-500">★★★★★</div>
                                <p className="text-3xl font-bold text-cyan-950">Quedó espectacular</p>
                    ...
                    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div className="flex items-center">
                            <div>
                                ...
                                <div className="text-yellow-500">★★★★★</div>
                                <p className="text-3xl font-bold text-cyan-950">Se lo recomendaré a mis familiares</p>
