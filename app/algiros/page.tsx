...
export const metadata = {
  title: 'Reformas integrales Algirós',
  description: 'Empresa de reformas en Algirós. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}
  ...
  return (
    <main>
          ...
          <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Algirós</h1>
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h2>Descubre tu nueva empresa de Reformas en Algirós, que sí cumple con lo que promete</h2>
              <hr></hr>
              ...
              <div className='grid grid-cols-3 gap-2 max-xl:px-5 px-44 max-lg:grid-cols-2 max-sm:grid-cols-1'>
                <img src={'https://' + roomMedia.fields.file.url} alt="Habitación de una casaf" width="300" height="380"  className='h-64 hover:scale-125 hover:border-2'/>
              ...
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Algirós</h2>
              <hr ></hr>
      ...
      {landingBarrios?.map((singlePost: any) => {
        const { body, title, bodyGrid, mediaGrid, bodyAlgirs } = singlePost.fields;
        return (
          <article key="beni">
            <div className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              ...
              <a className=' px-56 gap-5 max-xl:px-5 flex flex-col centrar text-left'>{documentToReactComponents(bodyAlgirs)}</a>
