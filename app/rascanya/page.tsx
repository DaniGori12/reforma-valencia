...
export const metadata = {
  title: 'Reformas integrales Rascanya',
  description: 'Empresa de reformas en Rascanya. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}

export default async function Rascanya() {
  ...
  return (
    <main>
        ...
        return (
          <div key="asdf">
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              ...
              <Boton></Boton>
              <h3 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas en Rascanya son tu mejor garantía</h3>
              <hr></hr>
              {body2}
              ...
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Rascanya</h2>
              <hr ></hr>
      ...
      {landingBarrios?.map((singlePost: any) => {
        const { body, title, bodyGrid, mediaGrid, bodyRascanya } = singlePost.fields;
        return (
          <main key="beni">
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              ...
              <a className=' px-56 gap-5 max-xl:px-5 flex flex-col centrar text-left'>{documentToReactComponents(bodyRascanya)}</a>
