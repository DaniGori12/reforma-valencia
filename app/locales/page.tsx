          ...
          <div key="asdf">
            <div className='max-h-72 w-screen pb-10 overflow-hidden relative bg-black '>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 text-white font-bold'>
                <p className='text-lg'>Reformas de Locales comerciales en Valencia </p>
            ...
            <div className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h3>Descubre tu nueva empresa de Reformas de Locales comerciales en Valencia, que sí cumple con lo que promete</h3>
              <hr></hr>
              ...
              <button className='boton'>SOLICITA TU PRESUPUESTO GRATIS</button>
              <h3 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas de Locales comerciales en Valencia son tu mejor garantía</h3>
              <hr></hr>
              {body2}
