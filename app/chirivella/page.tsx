...
export const metadata = {
  title: 'Reformas integrales Chirivella',
  description: 'Empresa de reformas en Chirivella. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}
...
export default async function Chirivella() {
  ...
  return (
        ...
        <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Chirivella</h1>
          ...
          <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
            <h2>Descubre tu nueva empresa de Reformas en Chirivella, que sí cumple con lo que promete</h2>
            <hr></hr>
           ...
           <Boton></Boton>
            ...
            <Boton></Boton>
            <h2>Comienza eligiendo el tipo de Reforma que deseas en Chirivella</h2>
            <hr ></hr>
          </article>
        </div>
      )
    ...
    {landingMunicipios?.map((singlePost: any) => {
      const { body, body2, mediaCocina2, mediaBano2, cocinaChirivella, banoChirivella, title, gridMedia, gridBody, bodyChirivella } = singlePost.fields;
      return (
        <main key={"alb"}>
          <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
            ...
            <Boton></Boton>
            <a className='mx-5 flex flex-col centrar text-left gap-5'>{documentToReactComponents(bodyChirivella)}</a>
          </article>
        </main>
      )
    })}
