...
export const metadata = {
  title: 'Reformas integrales Manises',
  description: 'Empresa de reformas en Manises. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}
          ...
          <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Manises</h1>
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h2>Descubre tu nueva empresa de Reformas en Manises, que sí cumple con lo que promete</h2>
              <hr></hr>
...
<img
  ...
  />
              ...
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Manises</h2>
              <hr ></hr>
            </article>
          </div>
        )
      ...
      {landingMunicipios?.map((singlePost: any) => {
        const { body, body2, mediaCocina3, mediaBano3, cocinaManises, banoManises, title, gridMedia, gridBody, bodyManises } = singlePost.fields;
        return (
          <main key={"alb"}>
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              ...
              <div className='grid grid-cols-2 px-56 gap-10 max-xl:px-5 max-xl:grid-cols-1 gap-5'>
                <div className='flex flex-col border-2 border-gray'>
                  <Link href="/cocinas">
                    <img
                      src={'https://' + mediaCocina3.fields.file.url} alt="asdf" width="300" height="280" className='hover:opacity-50 h-56'
                    />
                    <p>{cocinaManises}</p>
                  </Link>
                ...
                <div className='flex flex-col border-2 border-gray'>
                  <Link href="/banos">
                    <img
                      src={'https://' + mediaBano3.fields.file.url} alt="asdf" width="300" height="280" className='hover:opacity-50 h-56'
                    />
                    <p>{banoManises}</p>
                  </Link>
              ...
              <Boton></Boton>
              <a className='mx-5 flex flex-col centrar text-left gap-5'>{documentToReactComponents(bodyManises)}</a>
            </article>
          </main>
        )
      })}
