...
export const metadata = {
  title: 'Reformas integrales Mislata',
  description: 'Empresa de reformas en Mislata. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}
        ...
        <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Mislata</h1>
          ...
          <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
            <h2>Descubre tu nueva empresa de Reformas en Mislata, que sí cumple con lo que promete</h2>
            <hr></hr>
           ...
           <Boton></Boton>
            ...
            <div className='grid grid-cols-3 gap-2 max-xl:px-5 px-44 max-lg:grid-cols-2 max-sm:grid-cols-1'>
              ...
              />
              <img
                src={'https://' + roomMedia9.fields.file.url} alt="Habitación de una casa" width="300" height="380"
              />
            </div>
