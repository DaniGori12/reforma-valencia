...
export const metadata = {
  title: 'Reformas integrales Jesús',
  description: 'Empresa de reformas en Jesús. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}
  ...
  return (
    <main>
          ...
          <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Jesús</h1>
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h2>Descubre tu nueva empresa de Reformas en Jesús, que sí cumple con lo que promete</h2>
              <hr></hr>
              ...
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Jesús</h2>
              <hr ></hr>
      ...
      {landingBarrios?.map((singlePost: any) => {
        const { body, title, bodyGrid, mediaGrid, bodyJess } = singlePost.fields;
        return (
          <main key="beni">
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              ...
              <a className=' px-56 gap-5 max-xl:px-5 flex flex-col centrar text-left'>{documentToReactComponents(bodyJess)}</a>
