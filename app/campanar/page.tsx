...
export const metadata = {
  title: 'Reformas integrales Campanar',
  description: 'Empresa de reformas en Campanar. Más de 10 años de experiencia con clientes felices. Cumplimos con el tiempo y el presupuesto'
}
    ...
    <main>
      ...
      {landingTeam?.map((singlePost: any) => {
          ...
          <div key="asdf">
             <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Campanar</h1>
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h2>Descubre tu nueva empresa de Reformas en Campanar, que sí cumple con lo que promete</h2>
              <hr></hr>
              ...
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Campanar</h2>
              <hr ></hr>
       ...
       {landingBarrios?.map((singlePost: any) => {
        const {body, title, bodyGrid, mediaGrid, bodyCampanar } = singlePost.fields;
        return (
          <main key="cam">
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
