          ...
          <div key="asdf">
            <div className='max-h-96 w-screen pb-10 overflow-hidden relative'>
              ...
              <div className=' flex flex-col gap-5 items-center absolute inset-x-0 top-20 mx-1'>
                <h1 className='max-lg:text-base mt-5 flex titulo'> Reformas integrales en Catarroja</h1>
            ...
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h2>Descubre tu nueva empresa de Reformas en Catarroja, que sí cumple con lo que promete</h2>
              <hr></hr>
              ...
              <Boton></Boton>
              <h2 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas en Catarroja son tu mejor garantía</h2>
              <hr></hr>
              {body2}
...
<img
  ...
  />
      ...
      {landingMunicipios?.map((singlePost: any) => {
        const {body, body2, mediaCocina3, mediaBano3, cocinaCatarroja, banoCatarroja, title, gridMedia, gridBody, bodyCatarroja} = singlePost.fields;
        return (
          <main key={"alb"}>
            <article className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
