        ...
        return (
          <div key="asdf">
            ...
            <div className='flex text-center flex-col items-center mt-20 px-56 gap-10 max-xl:px-5'>
              <h1>Descubre tu nueva empresa de Reformas en Patraix, que sí cumple con lo que promete</h1>
              <hr></hr>
              ...
              <Boton></Boton>
              <h2 className='px-56 gap-10 max-xl:px-5'>Las opiniones de nuestros clientes de Reformas en Patraix son tu mejor garantía</h2>
              <hr></hr>
              {body2}
              <Carrusel></Carrusel>
              ...
              <Boton></Boton>
              <h2>Comienza eligiendo el tipo de Reforma que deseas en Patraix</h2>
              <hr ></hr>
